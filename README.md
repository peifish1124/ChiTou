...
- basic features
  - 創建旅行、搜尋過往所有參與過的旅行
    <img width="905" alt="截圖 2023-09-14 上午1 24 42" src="https://github.com/peifish1124/ChiTou/assets/58721888/0d543626-883a-49e5-8f11-08df4f65ffc7">
  - 旅行詳細介面
    - 對行程進行投票
    - 可以查看天氣、預估交通時間
- Google Maps API
  - 創建行程
    ...
    - 編輯筆記
    - 拖拉行程順序
      <img width="895" alt="截圖 2023-09-14 上午1 26 20" src="https://github.com/peifish1124/ChiTou/assets/58721888/411d1539-c4b1-4a2c-ba40-9db3fe299655">
...
- 通知
  ...
  - Line Bot
    - 我們的網站會提供 機器人的好友連結，使用者把機器人加進群組後，就會看到這個畫面
      <img width="1398" alt="截圖 2023-09-14 上午1 17 12" src="https://github.com/peifish1124/ChiTou/assets/58721888/a9121ecb-7e16-4882-b3ee-2cdb974d37f4">
    - 我們會請使用者輸入他們旅行的 ID，並為了驗證，會叫他們再輸入創辦者的名字
      <img width="1394" alt="截圖 2023-09-14 上午1 18 57" src="https://github.com/peifish1124/ChiTou/assets/58721888/98c66a86-9531-45d1-9044-38344ac80810">
    - 每當該群組的行程有變動時，例如：創建一個行程，回到 Line 群組畫面就會看到機器人通知更動後的整體行程
      <img width="1392" alt="截圖 2023-09-14 上午1 19 46" src="https://github.com/peifish1124/ChiTou/assets/58721888/3a4d7e79-c845-4758-87cf-241c3b251e60">
