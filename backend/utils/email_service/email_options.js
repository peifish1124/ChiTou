module.exports = {
  signup: (receiverName) => {
    ...
    const html = `<p>Hi <strong><i>${receiverName}</i></strong>, </p>
            <p>感謝你加入 <strong><i>ChiTou</i></strong>！你的帳號已成功創建。<br>
              ...
              點擊 <a href="https://chi-tou-git-adedevelop-peifish1124.vercel.app">這裡</a> 造訪我們的網站 <strong><i>ChiTou</i></strong>，與朋友一起展開新的旅程吧！</p>
  ...
  createTrip: (senderName, tripName) => {
    ...
    const html = `<p>Hi <strong><i>${senderName}</i></strong>, </p>\
            ...
            點擊 <a href="https://chi-tou-git-adedevelop-peifish1124.vercel.app">這裡</a> 造訪我們的網站 <strong><i>ChiTou</i></strong>，與朋友一同開啟新的旅程吧！</p>\
            <p>Best regards, <br>\
            ChiTou ;></p>`;
  ...
  preTrip: (receiverName, tripName) => {
    ...
    const html = `<p>Hi <strong><i>${receiverName}</i></strong>, </p>
            ...
            點擊 <a href="https://chi-tou-git-adedevelop-peifish1124.vercel.app">這裡</a> 前往我們的網站 <strong><i>ChiTou</i></strong>，與朋友一同開啟新的旅程吧！</p>
            <p>Best regards, <br>\
            ChiTou ;></p>`;
